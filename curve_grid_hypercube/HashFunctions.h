...
private:
    ...
    inline int calculate_ai(inputData const& x,double const& s,double const& w);
    inline int calculateH(vector<inputData> const& x,unsigned int whichHashFunction,double const& w,unsigned int const& k);
