...
template <class inputData>
ExactNeighboursVector<inputData>::ExactNeighboursVector(InputGenericVector<inputData> const& pointsVector,InputGenericVector<inputData> const& queriesVector,bool input){
...
template <class inputData>
ExactNeighboursVector<inputData>::ExactNeighboursVector(InputGenericVector<inputData> const& pointsVector,InputGenericVector<inputData> const& queriesVector){
    auto total_start = std::chrono::system_clock::now();
    for (unsigned int query=0; query<queriesVector.itemValues.size(); query++){
        auto start = std::chrono::system_clock::now();
        double min=INT32_MAX;
