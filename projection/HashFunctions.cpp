...
template <class inputData>
inline int HashFunctions<inputData>::calculateH(vector<inputData> const& x,unsigned int whichHashFunction,double const& w,unsigned int const& k){
...
template <class inputData>
unsigned int HashFunctions<inputData>::gCalculator(const vector<inputData>& x,unsigned int const& k,double const& w){
    unsigned int g=0;
...
template class HashFunctions<int>; //In order to not fail the compile as the compiler wants to see the data that the templated class will have.
template class HashFunctions<double>; //In order to not fail the compile as the compiler wants to see the data that the templated class will have.